        ...
        if (orderDoc.exists) {
          ...
          if (orderData.items && orderData.items.length > 0) {
            ...
            for (const item of orderData.items) {
              ...
              if (item.productId) {
                console.log('✏️ Updating product:', item.productId);
            ...
            if (updatedCount > 0) {
              await batch.commit();
              console.log(`✅ ${updatedCount} products marked as sold`);
            } else {
              console.warn('⚠️ No products updated - no valid productIds found');
            }
          } else {
